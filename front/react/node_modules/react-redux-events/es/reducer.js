import { DISPATCH_EVENT, ADD_EVENT_LISTENER, REMOVE_EVENT_LISTENER, REMOVE_ALL_LISTENERS_FOR_EVENT, REMOVE_ALL_LISTENERS_FOR_CONTEXT, SET_LOGLEVEL } from './constants';
...
var reactReduxEventReducer = function reactReduxEventReducer() {
  ...
  switch (action.type) {
    ...
    case REMOVE_ALL_LISTENERS_FOR_EVENT:
      return removeAllListenersForEvent(state, action);
    case REMOVE_ALL_LISTENERS_FOR_CONTEXT:
